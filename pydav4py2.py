...
def choice1():
    ...
    if choice in accepted_strings:
        newdir = raw_input('Enter the name of the new folder:\n')
        os.system("mkdir"+" "+"~/"+newdir)
        davurl = raw_input('Enter the webDAV URL:\n')
        u = getpass.getuser()
...
def choice2():
    ...
    unaccepted_strings = {'No', 'n', 'N', 'no'}
    if choice in accepted_strings:
        curdir = raw_input('Enter the name of a current folder for the mount:\n')
        davurl = raw_input('Enter the webDAV URL:\n')
        u = getpass.getuser()
