...
while True:
        try:
            ...
            if choice == 4:
                ...
                choice2opt1 = input("Please type the web address of the webDAV server:\n")
                choice2opt1 = str(choice2opt1)
                choice2opt2 = input("Please type the absolute path of the folder that you want to mount:\n")
